...
describe('Label 2: Gender', function () {
    ...
    it('TC-4.3 Verify that all option buttons are selectable and user can select only one: HE', function () {
        $$(sel.radioBtn)[gender.HE].click();
        expect($$(sel.radioBtn)[gender.HE].getText()).toEqual(exp.HE);
    });

    it('TC-4.3.1 Verify that all option buttons are selectable and user can select only one: SHE', function () {
        $$(sel.radioBtn)[gender.SHE].click();
        expect($$(sel.radioBtn)[gender.SHE].getText()).toEqual(exp.SHE);
    });

    it('TC-4.3.2 Verify that all option buttons are selectable and user can select only one: IT', function () {
