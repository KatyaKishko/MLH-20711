...
describe(' General', function () {
    ...
    // it('TC-2.3 Verify the keyboard navigation throughout the app', function () {
    //     browser.keys("Tab");
    // });

    it('TC-2.4 Verify that browser control menu is integrated = fill in the form and refresh page', function () {
